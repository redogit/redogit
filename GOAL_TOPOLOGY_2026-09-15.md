...
**State:** DESIGN REVIEW; draft PR #36.  
...
**Next:** implementation plan, then TDD implementation after plan review.  
...
S'1 design
  -> Experiment 0 implementation
      -> exact mirror/comparison kernel
      -> experience graph + replay/reframe
      -> baseline play/accessibility verification
          -> observer extensions
          -> image deformation adapter
          -> dimensional-ladder cross-checks
          -> Conscience64 observer bridge
          -> Hodge candidate bridge
          -> future S'1_Suggest training
```
